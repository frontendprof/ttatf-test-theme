...
function uni_files(){
    wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyDzjOkd5zGpMacKJFChrfj27J-SSxnrij0', NULL, 1.0, true );
...
function uniMapKey($api){
  $api['key']='AIzaSyDzjOkd5zGpMacKJFChrfj27J-SSxnrij0';
  return $api;
}
